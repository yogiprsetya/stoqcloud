...
interface SkuImportDialogProps {
  isOpen: boolean;
  onClose: () => void;
}

export function SkuImportDialog({ isOpen, onClose }: SkuImportDialogProps) {
  ...
  const handleSelectTemplate = () => {
    // TODO: ganti dengan URL template sebenarnya bila tersedia
    const templateUrl = '/templates/sku-import-template.csv';
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-xl">
        <DialogHeader>
          <DialogTitle>Import SKU (CSV)</DialogTitle>
